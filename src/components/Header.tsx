    ...
    <>
      <div className="bg-[url('./assets/images/phil-5i0GnoTTjSE-unsplash.jpg')] h-[50vh] bg-cover flex flex-col items-start place-content-center p-4 text-black bg-center">
        ...
        <div className="flex flex-row gap-x-2">
            <Link to="/Login">
              <button className="flex transition delay-50 duration-300 ease-in-out transform hover:scale-110 border border-black rounded-md p-2 rounded-md hover:bg-transparent bg-white">Login</button>
            </Link>
            <Link to="/Appointment">
