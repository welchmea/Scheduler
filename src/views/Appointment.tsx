          ...
          <div className="flex flex-col place-content-center gap-y-1">
            ...
            <div className="flex flex-col items-start text-xl border border-black bg-calendarBG p-4 rounded-md gap-y-4">
              ...
              <div className="flex flex-row w-full justify-around">
                {times.map((i) => (
                  <button className="transition delay-100 duration-300 ease-in-out transform hover:scale-110 p-3 border border-black bg-white rounded-md hover:bg-backgroundCard">
                    {i}
                  </button>
                ))}
              </div>
