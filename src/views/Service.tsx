  ...
  return (
    <>
      ...
      <div className="flex w-full z-10 absolute mt-48 justify-center text-black">
        <div className="flex flex-col border border-black rounded-md w-5/6 p-8">
          ...
          <div className="flex flex-row justify-between gap-x-2">
            <div className="flex flex-col w-1/3 text-xl">
              <div className="flex border border-black bg-white p-4 rounded-md mb-1">
            ...
            <div className="flex border border-black bg-white p-4 rounded-md mb-1">
              ...
              <div className="w-full p-3 bg-calendarBG borderborder-black rounded-md h-full">
              {styling.map((key) => (
                <ul className="flex justify-between p-4">
                  <div className="flex">{key.service}</div>
                  <div className="flex">{"$ " + key.price + ".00"}</div>
